...
public class ArraysAsList {
    public static void main(String[] args) {
        ...
        //nums.add(100); to add to the numbers don't work
        ...
        numsList.remove(0); // this will remove the number 4 since its index 0
        System.out.println("numsList = " + numsList);
        ...
        List<String> drinksWithCaffeine = new ArrayList<>(Arrays.asList("coffee", "tea", "monster", "red bull", "mdew", "kambucha", "coke", "pepsi", "celsius"));
