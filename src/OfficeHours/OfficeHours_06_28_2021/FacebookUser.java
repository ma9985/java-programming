package OfficeHours.OfficeHours_06_28_2021;
...
• Create a sendFriendRequest method that will accept a Facebook user object
 and send them a friend request. The method should return a boolean of if the friend request
  was sent (true) or if the friend request was not sent (false).
- If your friend list is at the 5000 limit then do not send the request and
print “You have reached the limit of friends.”
...
- If both the user and you are under the limit print:
 “Friend request sent to $theUsersName” and increase your number of friends by one.
 */
