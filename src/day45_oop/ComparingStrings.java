...
public class ComparingStrings {
    public static void main(String[] args) {
        ...
        String word4 = new String("java");//create NEW HEAP, outside String pool

        System.out.println("word2 = " + word2); //TRUE
        System.out.println("word3 = " + word3);  //FALSE
        System.out.println("word4 = " + word4);  //FALSE -> print to diff objects in HEAP
